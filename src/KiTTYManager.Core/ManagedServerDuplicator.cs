...
public static class ManagedServerDuplicator
{
    ...
    private static ManagedServer Create(ManagerConfig config, ManagedServer source, bool resetRuntime)
    {
        return new ManagedServer
        {
            ...
            EnableTcpKeepalives = source.EnableTcpKeepalives,
            ReconnectOnConnectionFailure = source.ReconnectOnConnectionFailure,
            ReconnectOnSystemWakeup = source.ReconnectOnSystemWakeup,
