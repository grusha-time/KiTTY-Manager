...
public partial class TextSettingsDialog : Window
{
        ...
        int maxGroupServersInRouteAttempts = 1)
    {
        ...
        MaxGroupServersInRouteAttemptsBox.Text = maxGroupServersInRouteAttempts.ToString();
    ...
    private void Save_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (!int.TryParse(MaxGroupServersInRouteAttemptsBox.Text.Trim(), out var maxGroupServers) || maxGroupServers is < 0 or > 100)
        {
            ThemedMessageDialog.Show(this, "Укажите максимум независимых серверов одной группы от 0 до 100.", "Настройки", MessageBoxButton.OK, MessageBoxImage.Warning);
            MaxGroupServersInRouteAttemptsBox.Focus();
            MaxGroupServersInRouteAttemptsBox.SelectAll();
            return;
        }
        MaxGroupServersInRouteAttempts = maxGroupServers;
